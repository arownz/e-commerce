...
function FeaturedProducts() {
  ...
  return (
    <Container className="py-5">
      ...
      <div className="mb-5">
        <h1 className="fw-bold mb-1">Featured Products</h1>
      ...
      {products.length === 0 ? (
        <div className="text-center py-5">
          ...
          <h3 className="mt-3">No featured products available</h3>
          <p className="text-muted">Check back soon for featured products</p>
